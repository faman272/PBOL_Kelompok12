...
public class TeamEdit {
    ...
    public void start(Team team, final Employee user) {
        ...
        removeTesterBtn.setOnAction(actionEvent -> {
            removeFromTeam("cyber security", team.getName());
        ...
        saveBtn.setOnAction(actionEvent -> {
            ...
            String cyber_security = (String) testerChoice.getSelectionModel().getSelectedItem();
            saveChanges(nameField.getText(), manager, analyst, designer, programmer, cyber_security, team.getName());
        });
    ...
    private void initialize(Team team) {
        ...
        testerChoice.getItems().addAll(Manager.getEmployeeList("Cyber Security"));
        testerChoice.getSelectionModel().select(Dashboard.getEmployeeName(team.getCyber_security()));
     ...
     * @param cybersecurity Cybersecurity name
    ...
    private void saveChanges(String newTeamName, String manager, String analyst, String designer, String programmer,
                             String cybersecurity, String teamName) {
        try {
            Connection con = Manager.getConnection();
            PreparedStatement preparedStatement = null;
            ...
            Integer cybersecurityID = Manager.getEmployeeId(cybersecurity);
            ...
            if (cybersecurityID != null) preparedStatement.setInt(6, cybersecurityID);
