...
public class Dashboard {
    ...
    public void start(final Employee user) {
        ...
        scene.getStylesheets().add("/styles/dashboard_style.css");
    ...
    private void loadProjects() {
        ...
        try {
            ...
            {
                // load view
                AnchorPane loader = FXMLLoader.load(getClass().getResource("/view/project.fxml"));
                ...
                Image image = new Image("/images/icons8-cashbook-80.png", 70, 70, true, false);
        ...
        try {
            ...
            if (resultSet.next())
            {
                team = new Team(resultSet.getString("t_name"), resultSet.getInt("manager"),
                        ...
                        resultSet.getInt("cybersecurity"));
                return team;
            }
